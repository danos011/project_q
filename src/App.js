...
function App() {
    ...
    return (
        <>
            ...
            {
                intro ?
                    <video autoPlay muted src="/video/intro.mp4"
                           className={`z-[-1] w-full object-cover h-[100vh] ${fadeOut ? 'fade-out' : ''}`}></video>
                    :
                    <NextUIProvider className={"container max-w-full overflow-y-hidden"}>
                        ...
                        <div className={`flex flex-col gap-[10vh]`}>
                            ...
                            <AboutUs title={"Сферы"} belowTitle={"деятельности"} boxTitle={"Кто"} coloredBoxTitle={"мы ?"}
                            ...
                            <PageWithText title={'web'} coloredText={'3'} afterTitle={"Инновационные решения"} textId={'web3'}
                            ...
                            <PageWithText title={'трей'} coloredText={'динг'} afterTitle={"торговые операции"} textId={'trading'}
