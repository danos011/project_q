...
export const PageWithText = ({title, coloredText, afterTitle, description, textId}) => {
    ...
    return (
        <section id={textId}
                 className="p-5 lg:p-10 lg:pr-[65px] h-[80vh] lg:h-[100vh] flex flex-col gap-4 items-center w-fit">
            ...
            <Card shadow={'none'} radius={"sm"}
                ...
                <CardBody
                    className={"p-5 h-full flex justify-center lg:px-[8rem] lg:py-[8rem] text-center font-bajazzo " +
